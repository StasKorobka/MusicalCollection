...
namespace MusicalCollection.Migrations
{
    ...
    [Migration("20250410175757_AddedNewEntities")]
            ...
            modelBuilder.Entity("MusicalCollection.Entities.Playlist", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PlaylistId = 1,
                            CreationDate = new DateTime(2025, 4, 10, 17, 57, 57, 188, DateTimeKind.Utc).AddTicks(4223),
            ...
            modelBuilder.Entity("MusicalCollection.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreationDate = new DateTime(2025, 4, 10, 17, 57, 57, 188, DateTimeKind.Utc).AddTicks(4173),
                            FirstName = "John",
                            LastName = "Doe"
                        });
                });
            ...
            modelBuilder.Entity("MusicalCollection.Entities.UserCollection", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserCollectionId = 1,
                            AdditionDate = new DateTime(2025, 4, 10, 17, 57, 57, 188, DateTimeKind.Utc).AddTicks(4190),
                            AlbumId = 1,
                            Status = 0,
                            UserId = 1
                        });
