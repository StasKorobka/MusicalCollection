...
namespace MusicalCollection.Migrations
{
    ...
    [Migration("20250411103702_AddedAlbumLength")]
    partial class AddedAlbumLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MusicalCollection.Entities.Playlist", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PlaylistId = 1,
                            CreationDate = new DateTime(2025, 4, 11, 10, 37, 1, 771, DateTimeKind.Utc).AddTicks(6479),
            ...
            modelBuilder.Entity("MusicalCollection.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreationDate = new DateTime(2025, 4, 11, 10, 37, 1, 771, DateTimeKind.Utc).AddTicks(6434),
                            FirstName = "John",
                            LastName = "Doe"
                        });
                });
            ...
            modelBuilder.Entity("MusicalCollection.Entities.UserCollection", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserCollectionId = 1,
                            AdditionDate = new DateTime(2025, 4, 11, 10, 37, 1, 771, DateTimeKind.Utc).AddTicks(6449),
                            AlbumId = 1,
                            Status = 0,
                            UserId = 1
                        });
